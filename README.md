#famosteroids
> Javascript version of a well-known game.

[![Build Status](https://travis-ci.org/SeanMEpi/famosteroids.svg?branch=master)](https://travis-ci.org/SeanMEpi/famosteroids) [![Dependency Status](https://david-dm.org/SeanMEpi/famosteroids.svg)](https://david-dm.org/SeanMEpi/famosteroids) [![devDependency Status](https://david-dm.org/SeanMEpi/famosteroids/dev-status.svg)](https://david-dm.org/SeanMEpi/famosteroids#info=devDependencies)
...
## Release History
 * 2014-12-21   v0.1.0   Generated by the [Yeoman Generator](https://github.com/FamousTools/generator-famous) for [Famo.us](http://famo.us)